...
5. 在本地jilyjiang.github.io文件夹下通过Git bash依次执行
```bash
$ npm install hexo
$ hexo init
$ npm install 
...
这样一来，在GitHub上的jilyjiang.github.io仓库就有两个分支，一个hexo分支用来存放网站的原始文件，一个master分支用来存放生成的静态网页。
